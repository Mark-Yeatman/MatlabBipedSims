...
global flowdata
    ...
    if strcmp(phase,'SSupp')
        ...
        GenE = 1/2*flowdata.Parameters.SLIP.k*(L-flowdata.Parameters.SLIP.L0).^2 ...
            + 1/2*flowdata.Parameters.Biped('m')*(x(3)^2+x(4)^2) ...
            + flowdata.Parameters.Biped('m')*x(2)*flowdata.Parameters.Environment.g;

%         GenE = 1/2*flowdata.Parameters.SLIP.k*(L-flowdata.Parameters.SLIP.L0).^2 ...
%              + 1/2*flowdata.Parameters.Biped('m')*(Ldot^2);
    ...
    elseif strcmp(phase,'DSupp')
        ...
        GenE = 1/2*flowdata.Parameters.SLIP.k*(L1-flowdata.Parameters.SLIP.L0).^2 ...
             + 1/2*flowdata.Parameters.Biped('m')*(x(3)^2+x(4)^2) ...
             + flowdata.Parameters.Biped('m')*x(2)*flowdata.Parameters.Environment.g;

%         GenE = 1/2*flowdata.Parameters.SLIP.k*(L1-flowdata.Parameters.SLIP.L0).^2 ...
%              + 1/2*flowdata.Parameters.Biped('m')*(Ldot1^2);
        ...
        GenE = 1/2*flowdata.Parameters.SLIP.k*(L2-flowdata.Parameters.SLIP.L0).^2 ...
             + 1/2*flowdata.Parameters.Biped('m')*(x(3)^2+x(4)^2)...
             + flowdata.Parameters.Biped('m')*x(2)*flowdata.Parameters.Environment.g;
        
%         GenE = 1/2*flowdata.Parameters.SLIP.k*(L2-flowdata.Parameters.SLIP.L0).^2 ...
%              + 1/2*flowdata.Parameters.Biped('m')*(Ldot2^2);
